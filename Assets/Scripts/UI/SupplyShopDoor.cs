...
{
    /// <summary>
    /// Opens the linked <see cref="SupplyShop"/> when the player walks through this trigger.
    /// Place it over a building doorway and size its BoxCollider2D to match the door art.
    /// </summary>
